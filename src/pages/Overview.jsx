...
import { PRODUCTS_ENRICHED, MONTHLY_REVENUE, filterProducts, filterRevenue } from '../data';
...
export default function Overview({ filters }) {
  ...
  const belowROP = products.filter(p => p.status !== 'OK').length;
  ...
  products.forEach(p => { fsnCounts[p.fsn]++; });
